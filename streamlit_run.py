...
def main():
    ...
    with st.form("assessment_form"):
        ...
        walk_time = st.number_input("4米步行时间 (秒)", min_value=0.1, step=0.1, format="%.1f")
    ...
    if submitted:
        ...
        new_entry = {
            ...
            '年龄': age,
            '性别': gender,
            '步速(m/s)': f"{gait_speed:.3f}" if gait_speed is not None else "N/A",
            '评估结果': result,
            '评估时间': eval_time
        }
